...
def cursor_to_dict(cursor, many=True):
    """
    Retorna un objeto de una consulta en lista o diccionario
    :param cursor: (cursor) Cursor de la base de datos
    :param many: (boolean) Establece que si se recuperan todos o solo uno de los datos
    :return:
    """
...
def json_procedure(procedure_name, *proc_params, **kwargs):
    """
    Ejecuta un procedimiento almacenado y retorna un objeto de tipo json como string
    :param procedure_name: (string) Nombre de la funcion a ejecutarse en la bd
    :param proc_parmas: (lista)     lista de los parametros que recibe el procedimiento almacenado
    :return: (string)               El json en forma de string
    """
...
def full_complex_procedure(fields, procedure_name, *proc_params):
    """
    Ejecuta un procedimiento almacenado especificando los campos a ser devueltos,
...
def simple_view(view_name, **kwargs):
    """
    Llama a una vista o tabla y retorna los datos de la misma como un diccionario
    ...
    """
    cursor = connection.cursor()
    # Se verifica que se envio un order by
...
class DataBaseGeneric(object):
    """
    Objeto generica para la gestion de procedimiento alamcenados y vistas
    """
...
class DataBaseView(DataBaseGeneric):
    def __init__(self, view_name=None, connection_name=None):
        """
        Se encarga de llamar a una vista dentro de la base de datos
...
class DataBaseProcedure(DataBaseGeneric):
    """
    Se Encarga de llamar a un procedimiento almacenado
    """
    def __init__(self, procedure_name: str, database=None):
        """
        Se encarga de gestionar una llamada a un procedimiento almacenado de postgres
    ...
    def get_message(self):
        """
        Retorna el mensaje asociado en caso que el procedimiento almacenado retorne
        un tipo result_msg
